...
export default function HomePage() {
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
      ...
      <div className="overflow-y-auto px-8 py-12 space-y-10">
        ...
        <p>
          Track your candidates, manage tasks, and store HR-related notes — all in one clean, fast and user-friendly interface.
        </p>
        <p>
          Whether you're a solo recruiter, part of a startup, or an HR pro, HiReBOOK helps you stay organized and focused.
        </p>
        <p>
          💡 More features coming soon — including app downloads and team collaboration.
        </p>
